...
## Condition Statement and Experiment Result:
  ...
  Illustration: The test data is gathered from Desktop PC running Linux 16.04 connected to the Local Area Network through wire. The     time delay when ping itself is ignorable and can refer to Wired Control group shows in Diagram 1.2.
