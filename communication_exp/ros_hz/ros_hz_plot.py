...
file = open('ros_hz_coretalklisten_data.txt','r')
data_list = []
for i in file:
...
plt.text(0,1270,r'$\mu=%f,\ \sigma=%f$'%(average,std_dev))
plt.title("Senario 1 Node1 :Master Node2 :Talker Node3 :Listener")
plt.xlabel("Time in second")
plt.ylabel("Frequncy in Hz")
file.close()

#Visualize Second Node

file = open('ros_hz_coretalkerlistenlisten_data.txt','r')
data_list = []
for i in file:
	data_list.append(float(i))
general_list.append(data_list[0:180])
...
std_dev = st.stdev(data_list[0:180])
average = st.mean(data_list[0:180])
plt.text(0,940,r'$\mu=%f,\ \sigma=%f$'%(average,std_dev))
...
file = open('ros_hz_blocked_data.txt','r')
data_list = []
for i in file:
	data_list.append(float(i))
general_list.append(data_list[0:180])
...
std_dev = st.stdev(data_list[0:180])
average = st.mean(data_list[0:180])
plt.text(0,920,r'$\mu=%f,\ \sigma=%f$'%(average,std_dev))
...
file = open('ros_hz_control_data.txt','r')
data_list = []
for i in file:
	data_list.append(float(i))
general_list.append(data_list[0:180])
